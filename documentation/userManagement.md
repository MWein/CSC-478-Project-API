...
<br />*Note*: This is a method for a user with Manager permissions to change the password of another user. This is not for a user to set their own password. /setPassword is used for that.
